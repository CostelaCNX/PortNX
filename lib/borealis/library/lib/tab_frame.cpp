    ...
    : AppletFrame(false, true)
{
    ...
    // Enable touch support for TabFrame
    this->touchable = true;
}
...
void TabFrame::addTab(std::string label, View* view, bool focusable)
{
