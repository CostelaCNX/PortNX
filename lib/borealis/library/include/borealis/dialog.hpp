...
class DialogButton : public View
{
  ...
  public:
    ...
    void click(View* sender) override;

    void draw(NVGcontext* vg, int x, int y, unsigned width, unsigned height, Style* style, FrameContext* ctx);
};
...
class Dialog : public View
{
  private:
    ...
    View* currentTouchableView = nullptr;
