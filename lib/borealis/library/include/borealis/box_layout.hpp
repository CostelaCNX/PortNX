...
class BoxLayout : public View
{
  private:
    ...
    long int scrollOffset = 1; // which way are we going in the children list
    long int firstItem = 0; // which way are we going in the children list
  ...
  public:
    ...
    void setScrollOffset(long int offset);
    void setFirstItem(long int index);
    int getFirstItem();
